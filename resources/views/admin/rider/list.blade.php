    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="{{ route('admin.client.add') }}" class="btn btn-sm fw-bold btn-primary">Add</a>
            </div>
        </div>
    </div>
                                    ...
                                    <tr style="white-space: nowrap;">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center flex-shrink-0">
                                                <a href="{{ route('admin.client.edit', $Client) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    <i class="fa-solid fa-pen-to-square text-primary"></i>
                                                </a>
                                                @if($Client->ClientActive)
                                                <form action="{{ route('admin.client.active', $Client) }}" method="post">
                                                    @csrf
