            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-px text-center row">
                        <form class="form row" action="{{ route('admin.report.accident.list') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                <thead>
                                    <tr style="white-space: nowrap;" class="fw-bold text-muted">
                                        ...
                                        <th>
                                            <form action="{{ route('admin.report.accident.details') }}" method="post">
                                                @csrf
