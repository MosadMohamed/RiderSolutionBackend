                    ...
                    <div class="w-md-400px">
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="post" action="{{route('admin.login.submit')}}">
                            ...
                            <div class="fv-row mb-8">
                                <input type="text" placeholder="Email" name="UserEmail" autocomplete="off" class="form-control bg-transparent" />
                            </div>
                            <div class="fv-row mb-3">
                                <input type="password" placeholder="Password" name="UserPassword" autocomplete="off" class="form-control bg-transparent" />
                            </div>
