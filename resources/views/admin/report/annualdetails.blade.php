    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Annuals Details Report</h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">Annuals</li>
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-400 w-5px h-2px"></span>
                    </li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-px text-center row">
                        <form class="form row" action="{{ route('admin.report.annual.details') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <tbody>
                                    ...
                                    <tr style="white-space: nowrap;">
                                        ...
                                        <td>
                                            {{ $Annual->Rider->RiderName }}_<span class="text-success">{{ $Annual->Rider->Office->OfficeName }}</span>
                                        </td>
                                        <td>
                                            <img src="{{ asset('images/companies/' . $Annual->Company->CompanyImage) }}" width="50">
                                            {{ $Annual->Company->CompanyNameEn }}
                                        </td>
                                        <td>{{ $Annual->AnnualDate }}</td>
                                    </tr>
                                    @endforeach
                                    <tr style="white-space: nowrap;">
                                        <td>#</td>
